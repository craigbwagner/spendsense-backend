...
def update_categories_budget():
    try:
        ...
        cursor.execute(
            ...
            """,
            (
                updated_budgets_data["housing"],
                updated_budgets_data["transportation"],
                updated_budgets_data["food_groceries"],
                updated_budgets_data["utilities"],
                updated_budgets_data["clothing"],
                updated_budgets_data["medical"],
                updated_budgets_data["insurance"],
                updated_budgets_data["personal"],
                updated_budgets_data["education"],
                updated_budgets_data["entertainment"],
                updated_budgets_data["other"],
                user_id,
            ),
        )
